              ...
              <div class="content-box">
                <div class="fire-item">
                  <div>
                    ...
                    <div
                      class="hot-comment"
                      v-show="msg.hot_comment.comment_info"
                    >
                      <div class="hot-title">
                        <svg
                          data-v-88398272=""
                      ...
                      <div>
                        ...
                        <div
                          ...
                          v-if="
                            msg.hot_comment.comment_info &&
                            msg.hot_comment.comment_info.comment_content
                              .length >= 80 &&
                            msg.hot_comment.comment_info.show_content.length <=
                              83
                          "
                          @click="
                            showFullHotContent(
                  ...
                  <div class="operation">
                    ...
                    <div
                      ...
                      @click="
                        showComment(msg.msg_id, curMsgId === msg.msg_id, 0)
                      "
                    >
